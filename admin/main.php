...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración |DeeJay Michael Jet</title>
  ...
  <body class="skin-red fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo"><b>DeeJay </b> Michael Jet </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2020 - <a href="http://djmichaeljet.com/home/">DeeJay Michael Jet</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
