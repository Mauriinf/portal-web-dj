                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div style="padding: 0 10px;text-align:justify"> 
                            ...
                            <p><i style="margin-right:10px" class="fa fa-map-marker"></i>Cúcuta N-S, Colombia</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-phone"></i>+57 3176805258</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-envelope"></i>info@djmichaeljet.com</p>
                        </div>
                    </div>
                </div>
            </div>
